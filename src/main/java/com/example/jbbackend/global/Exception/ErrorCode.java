...
public enum ErrorCode {
    ...
    // Credit
    CREDIT_INSUFFICIENT(HttpStatus.BAD_REQUEST, "CRE001", "보유 크레딧이 부족합니다."),
    INVALID_CREDIT_AMOUNT(HttpStatus.BAD_REQUEST, "CRE002", "사용 크레딧은 0보다 커야 합니다."),
    ...
    EMAIL_IS_ALREADY_REGISTERED(HttpStatus.CONFLICT, "SMT002", "이미 등록된 이메일입니다."),
    ...
    PAYMENT_UNRECOGNIZED_RESPONSE(HttpStatus.INTERNAL_SERVER_ERROR, "PAY102", "지원하지 않는 결제 응답입니다."),
    PAYMENT_GATEWAY_ERROR(HttpStatus.BAD_GATEWAY, "PAY103", "결제 대행사 통신에 실패했습니다."),
    PAYMENT_TIMEOUT(HttpStatus.GATEWAY_TIMEOUT, "PAY104", "결제 요청 시간이 초과되었습니다.");
